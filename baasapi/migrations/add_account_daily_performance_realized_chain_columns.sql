...
-- SQLite:
--   sqlite3 baasapi/sqlite/tradingbots.db ".read baasapi/migrations/add_account_daily_performance_realized_chain_columns.sql"
-- PostgreSQL（可将 REAL 改为 DOUBLE PRECISION）:
--   psql "$DATABASE_URL" -f baasapi/migrations/add_account_daily_performance_realized_chain_columns.sql
