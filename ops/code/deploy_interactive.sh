...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 🖥️  deploy2Local.sh — 本地开发（→ aws-ops/code/deploy_orchestrator.py local）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

📌 作用概要
  · 🐍 可选：本机 aws-ops/code/install_python_deps.sh
...
EOF
  ...
  echo "📋 即将执行"
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo "  python3 aws-ops/code/deploy_orchestrator.py local ${HZTECH_WIZARD_ARGS[*]}"
  echo ""
  printf "确认执行？[y/N] "
  read -r yn
  case "$yn" in
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 🚀 deploy2AWS.sh — AWS 部署（→ aws-ops/code/deploy_orchestrator.py aws）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
EOF
  ...
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo "  python3 aws-ops/code/deploy_orchestrator.py aws ${HZTECH_WIZARD_ARGS[*]}"
  echo ""
  echo "  相关环境变量（摘要）："
