...
数据库自检脚本。亦可通过：./aws-ops/database/pg_ops.sh test-local 或 aws-ops/aws_test.sh 选 6
...
用法：
  ...
  python3 aws-ops/database/test_local_postgres.py
  DATABASE_URL=postgresql://u:p@host:5432/db python3 aws-ops/database/test_local_postgres.py
